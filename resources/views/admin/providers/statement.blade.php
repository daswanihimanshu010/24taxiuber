                ...
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #4bcb73 !important;">
                        ...
                        <div class="t-content">
                            ...
                            <i class="fa fa-caret-up text-success mr-0-5"></i><span>of {{$pagination->total}} Request</span>
                        </div>
                    </div>
                </div>
                @else
                <div class="col-lg-4 col-md-6 col-xs-12">
                    <div class="box box-block bg-white tile tile-1 mb-2" style="border-top-color: #4bcb73 !important;">
                        ...
                        <div class="t-content">
                            ...
                            <h1 class="mb-1">{{currency($revenue[0]->overall)}}</h1>
                            <i class="fa fa-caret-up text-success mr-0-5"></i><span>of {{$pagination->total}}
                                Requests</span>
                        </div>
                    </div>
                </div>
