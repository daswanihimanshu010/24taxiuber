                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input class="form-control" type="text"
                                                value="{{ config('constants.site_title', 'Thinkin Cab')  }}"
                                        ...
                                        <div class="col-xs-9">
                                            <select class="form-control" id="timezone" name="timezone"
                                                ...
                                                <option value="America/Havana"
                                                    @if(Config::get('constants.timezone')=='America/Havana' ) selected
                                                    @endif>(GMT-05:00) Cuba</option>
                                                <option value="America/Bogota"
                                                    @if(Config::get('constants.timezone')=='America/Bogota' ) selected
                                                    @endif>(GMT-05:00) Bogota, Lima, Quito, Rio Branco
                                                </option>
                                                <option value="America/Caracas"
                                                    @if(Config::get('constants.timezone')=='America/Caracas' ) selected
                                                    @endif>
                                                    (GMT-04:30) Caracas</option>
                                                <option value="America/Santiago"
                                                    @if(Config::get('constants.timezone')=='America/Santiago' ) selected
                                                    @endif>
                                                ...
                                                <option value="Atlantic/Stanley"
                                                    @if(Config::get('constants.timezone')=='Atlantic/Stanley' ) selected
                                                    @endif>
                                                    (GMT-04:00) Faukland Islands</option>
                                                <option value="America/Campo_Grande"
                                                    @if(Config::get('constants.timezone')=='America/Campo_Grande' )
                                                    selected @endif>
                                                    (GMT-04:00) Brazil</option>
                                                <option value="America/Goose_Bay"
                                                    @if(Config::get('constants.timezone')=='America/Goose_Bay' )
                                                    selected @endif>
                                                    (GMT-04:00) Atlantic Time (Goose Bay)</option>
                                                <option value="America/Glace_Bay"
                                                    @if(Config::get('constants.timezone')=='America/Glace_Bay' )
                                                    selected @endif>
                                                    (GMT-04:00) Atlantic Time (Canada)</option>
                                                <option value="America/St_Johns"
                                                    @if(Config::get('constants.timezone')=='America/St_Johns' ) selected
                                                    @endif>
                                                    (GMT-03:30) Newfoundland</option>
                                                <option value="America/Araguaina"
                                                    @if(Config::get('constants.timezone')=='America/Araguaina' )
                                                    selected @endif>
                                                    (GMT-03:00) UTC-3</option>
                                                <option value="America/Montevideo"
                                                    @if(Config::get('constants.timezone')=='America/Montevideo' )
                                                    selected @endif>
                                                    (GMT-03:00) Montevideo</option>
                                                <option value="America/Miquelon"
                                                    @if(Config::get('constants.timezone')=='America/Miquelon' ) selected
                                                    @endif>
                                                    (GMT-03:00) Miquelon, St. Pierre</option>
                                                <option value="America/Godthab"
                                                    @if(Config::get('constants.timezone')=='America/Godthab' ) selected
                                                    @endif>
                                                    (GMT-03:00) Greenland</option>
                                                <option value="America/Argentina/Buenos_Aires"
                                                    @if(Config::get('constants.timezone')=='America/Argentina/Buenos_Aires'
                                                    ) selected @endif>
                                                    (GMT-03:00) Buenos Aires</option>
                                                <option value="America/Sao_Paulo"
                                                    @if(Config::get('constants.timezone')=='America/Sao_Paulo' )
                                                    selected @endif>
                                                    (GMT-03:00) Brasilia</option>
                                                <option value="America/Noronha"
                                                    @if(Config::get('constants.timezone')=='America/Noronha' ) selected
                                                    @endif>
                                                    (GMT-02:00) Mid-Atlantic</option>
                                                <option value="Atlantic/Cape_Verde"
                                                    @if(Config::get('constants.timezone')=='Atlantic/Cape_Verde' )
                                                    selected @endif>
                                                    (GMT-01:00) Cape Verde Is.</option>
                                                <option value="Atlantic/Azores"
                                                    @if(Config::get('constants.timezone')=='Atlantic/Azores' ) selected
                                                    @endif>
                                                    (GMT-01:00) Azores</option>
                                                <option value="Europe/Belfast"
                                                    @if(Config::get('constants.timezone')=='Europe/Belfast' ) selected
                                                    @endif>(GMT) Greenwich Mean Time : Belfast</option>
                                                <option value="Europe/Dublin"
                                                    @if(Config::get('constants.timezone')=='Europe/Dublin' ) selected
                                                    @endif>(GMT) Greenwich Mean Time : Dublin</option>
                                                <option value="Europe/Lisbon"
                                                    @if(Config::get('constants.timezone')=='Europe/Lisbon' ) selected
                                                    @endif>(GMT) Greenwich Mean Time : Lisbon</option>
                                                <option value="Europe/London"
                                                    @if(Config::get('constants.timezone')=='Europe/London' ) selected
                                                    @endif>(GMT) Greenwich Mean Time : London</option>
                                                <option value="Africa/Abidjan"
                                                    @if(Config::get('constants.timezone')=='Africa/Abidjan' ) selected
                                                    @endif>(GMT) Monrovia, Reykjavik</option>
                                                <option value="Europe/Amsterdam"
                                                    @if(Config::get('constants.timezone')=='Europe/Amsterdam' ) selected
                                                    @endif>
                                                    (GMT+01:00) Amsterdam, Berlin, Bern, Rome, Stockholm, Vienna
                                                </option>
                                                <option value="Europe/Belgrade"
                                                    @if(Config::get('constants.timezone')=='Europe/Belgrade' ) selected
                                                    @endif>
                                                    (GMT+01:00) Belgrade, Bratislava, Budapest, Ljubljana, Prague
                                                </option>
                                                <option value="Europe/Brussels"
                                                    @if(Config::get('constants.timezone')=='Europe/Brussels' ) selected
                                                    @endif>
                                                    (GMT+01:00) Brussels, Copenhagen, Madrid, Paris</option>
                                                <option value="Africa/Algiers"
                                                    @if(Config::get('constants.timezone')=='Africa/Algiers' ) selected
                                                    @endif>(GMT+01:00) West Central Africa</option>
                                                <option value="Africa/Windhoek"
                                                    @if(Config::get('constants.timezone')=='Africa/Windhoek' ) selected
                                                    @endif>
                                                    (GMT+01:00) Windhoek</option>
                                                <option value="Asia/Beirut"
                                                    @if(Config::get('constants.timezone')=='Asia/Beirut' ) selected
                                                    @endif>(GMT+02:00) Beirut</option>
                                                <option value="Africa/Cairo"
                                                    @if(Config::get('constants.timezone')=='Africa/Cairo' ) selected
                                                    @endif>(GMT+02:00) Cairo</option>
                                                <option value="Asia/Gaza"
                                                    @if(Config::get('constants.timezone')=='Asia/Gaza' ) selected
                                                    @endif>(GMT+02:00) Gaza</option>
                                                <option value="Africa/Blantyre"
                                                    @if(Config::get('constants.timezone')=='Africa/Blantyre' ) selected
                                                    @endif>
                                                    (GMT+02:00) Harare, Pretoria</option>
                                                <option value="Asia/Jerusalem"
                                                    @if(Config::get('constants.timezone')=='Asia/Jerusalem' ) selected
                                                    @endif>(GMT+02:00) Jerusalem</option>
                                                <option value="Europe/Minsk"
                                                    @if(Config::get('constants.timezone')=='Europe/Minsk' ) selected
                                                    @endif>(GMT+02:00) Minsk</option>
                                                <option value="Asia/Damascus"
                                                    @if(Config::get('constants.timezone')=='Asia/Damascus' ) selected
                                                    @endif>(GMT+02:00) Syria</option>
                                                <option value="Europe/Moscow"
                                                    @if(Config::get('constants.timezone')=='Europe/Moscow' ) selected
                                                    @endif>(GMT+03:00) Moscow, St. Petersburg, Volgograd
                                                </option>
                                                <option value="Africa/Addis_Ababa"
                                                    @if(Config::get('constants.timezone')=='Africa/Addis_Ababa' )
                                                    selected @endif>
                                                    (GMT+03:00) Nairobi</option>
                                                <option value="Asia/Tehran"
                                                    @if(Config::get('constants.timezone')=='Asia/Tehran' ) selected
                                                    @endif>(GMT+03:30) Tehran</option>
                                                <option value="Asia/Dubai"
                                                    @if(Config::get('constants.timezone')=='Asia/Dubai' ) selected
                                                    @endif>(GMT+04:00) Abu Dhabi, Muscat</option>
                                                <option value="Asia/Yerevan"
                                                    @if(Config::get('constants.timezone')=='Asia/Yerevan' ) selected
                                                    @endif>(GMT+04:00) Yerevan</option>
                                                <option value="Asia/Kabul"
                                                    @if(Config::get('constants.timezone')=='Asia/Kabul' ) selected
                                                    @endif>(GMT+04:30) Kabul</option>
                                                <option value="Asia/Yekaterinburg"
                                                    @if(Config::get('constants.timezone')=='Asia/Yekaterinburg' )
                                                    selected @endif>
                                                    (GMT+05:00) Ekaterinburg</option>
                                                <option value="Asia/Tashkent"
                                                    @if(Config::get('constants.timezone')=='Asia/Tashkent' ) selected
                                                    @endif>(GMT+05:00) Tashkent</option>
                                                <option value="Asia/Kolkata"
                                                    @if(Config::get('constants.timezone')=='Asia/Kolkata' ) selected
                                                    @endif>(GMT+05:30) Chennai, Kolkata, Mumbai, New Delhi
                                                </option>
                                                <option value="Asia/Katmandu"
                                                    @if(Config::get('constants.timezone')=='Asia/Katmandu' ) selected
                                                    @endif>(GMT+05:45) Kathmandu</option>
                                                <option value="Asia/Dhaka"
                                                    @if(Config::get('constants.timezone')=='Asia/Dhaka' ) selected
                                                    @endif>(GMT+06:00) Astana, Dhaka</option>
                                                <option value="Asia/Novosibirsk"
                                                    @if(Config::get('constants.timezone')=='Asia/Novosibirsk' ) selected
                                                    @endif>
                                                    (GMT+06:00) Novosibirsk</option>
                                                <option value="Asia/Rangoon"
                                                    @if(Config::get('constants.timezone')=='Asia/Rangoon' ) selected
                                                    @endif>(GMT+06:30) Yangon (Rangoon)</option>
                                                <option value="Asia/Bangkok"
                                                    @if(Config::get('constants.timezone')=='Asia/Bangkok' ) selected
                                                    @endif>(GMT+07:00) Bangkok, Hanoi, Jakarta</option>
                                                <option value="Asia/Krasnoyarsk"
                                                    @if(Config::get('constants.timezone')=='Asia/Krasnoyarsk' ) selected
                                                    @endif>
                                                    (GMT+07:00) Krasnoyarsk</option>
                                                <option value="Asia/Hong_Kong"
                                                    @if(Config::get('constants.timezone')=='Asia/Hong_Kong' ) selected
                                                    @endif>(GMT+08:00) Beijing, Chongqing, Hong Kong, Urumqi
                                                </option>
                                                <option value="Asia/Irkutsk"
                                                    @if(Config::get('constants.timezone')=='Asia/Irkutsk' ) selected
                                                    @endif>(GMT+08:00) Irkutsk, Ulaan Bataar</option>
                                                <option value="Australia/Perth"
                                                    @if(Config::get('constants.timezone')=='Australia/Perth' ) selected
                                                    @endif>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <input class="form-control" type="number"
                                                ...
                                                required id="sos_number" placehold="@lang('admin.setting.SOS_Number')">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-8">
                                            <select name="currency" class="form-control" required>
                                                <option @if(config('constants.currency')=="Rs" ) selected @endif value="Rs">
