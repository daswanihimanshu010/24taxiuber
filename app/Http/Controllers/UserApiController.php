...
class UserApiController extends Controller
{
    ...
    public function send_request(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'message' => ($UserRequest->status == 'SCHEDULED') ? 'Ride schedule created! ' : 'New Ride created!',
     ...
     * @return \Illuminate\Http\Response
     */
    public function send_track_request(Request $request)
    {
        ...
        try {
            $UserTrack = User::where('mobile', $request->mobile)->firstOrFail();
        } catch (Exception $e) {
            try {
                $UserTrack = User::where('email', $request->email)->firstOrFail();
            } catch (Exception $e) {
                $UserTrack = User::create([
        ...
        $UserRequest->user_id = Auth::user()->id;
        $UserRequest->user_track_id = $UserTrack->id;
