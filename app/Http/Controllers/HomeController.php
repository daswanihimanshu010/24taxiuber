...
class HomeController extends Controller
{
    ...
    {
        $this->middleware('auth', ['except' => ['save_subscription','track','track_location']]);
    ...
    */
    ...
    {
        $ride = UserRequests::select(
            'user_requests.s_latitude', 'user_requests.s_longitude', 'users.first_name', 'users.last_name')->leftjoin('users', 'users.id', '=', 'user_requests.user_id')->where('user_requests.id', $id)->first();
        if ($ride != null) {
