...
<head>
  ...
  <title><?php echo e(config('constants.site_title','Moob')); ?> - Trip</title>
...
<body>
  ...
  <div class="page-content dashboard-page" style="padding-top: 10px">
    <div class="container">
      <h3><?php echo e(substr_replace($ride->first_name,"***",-1)); ?>'s Trip</h3>
      <div class="col-md-12">
  ...
  <script src="<?php echo e(asset('main/vendor/jquery/jquery-1.11.3.min.js')); ?>"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('constants.map_key')); ?>"></script>
  <script type="text/javascript">
    ...
    function initialize() {
      ...
      map.setCenter({
        lat: parseFloat('<?php echo e($ride->s_latitude); ?>'),
        lng: parseFloat('<?php echo e($ride->s_longitude); ?>')
      });
    ...
    function track() {
      $.ajax({
        ...
        success: function(response) {
          ...
          milliseconds = ((response.minutes * 60) * 1000); 
          ...
          if (localStorage.starting_point != response.source || localStorage.destination_point != response
            .destination) {
