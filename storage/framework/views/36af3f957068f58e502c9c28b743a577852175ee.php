...
<html>
    <head>
        ...
        <!-- Dynamic Colors -->
        <?php echo $__env->make('larecipe::style', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <body>
        <div id="app" v-cloak>
            <?php echo $__env->make('larecipe::partials.nav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>

            <?php echo $__env->make('larecipe::plugins.search', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
