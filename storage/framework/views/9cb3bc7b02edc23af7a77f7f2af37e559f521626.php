...
<div class="row white-section pad-60 no-margin">
    <div class="container">
        ...
        <div class = "col-md-4 content-block small">
            ...
                        <p> You can drive with <?php echo e(config ('constants.site_title', 'Thinkin Cab')); ?> anytime, day or night, 365 days a year. Travel does not interfere with your routine, you make your schedules, go offline at any time. </p>
                    </div>
                </div>
...
<div class="row white-section pad-60 no-margin">
    <div class="container">
        ...
        <div class="col-md-4 content-block small">
            ...
            <h2>Segurança</h2>
            <div class="title-divider"></div>
            <p>When you drive with <?php echo e(config ('constants.site_title', 'Thinkin Cab')); ?>, you get 24/7 support. All runners are verified with their personal information and phone number. That way you will know who is traveling and so will we. </p>
        </div></div>
