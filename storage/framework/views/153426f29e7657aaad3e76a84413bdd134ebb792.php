    ...
    <div class="row white-section pad-60 no-margin">
        <div class="container ">
            ...
            <div class="col-md-4 content-block small">
                ...
                <p><?php echo e(config('constants.site_title', 'Moob')); ?> it's the smartest way to get around. One touch and a car or motorcycle comes to you. Your driver knows exactly where to go. And you can pay with cash or card. </p>
            </div>
        </div>
            ...
            <div class="col-md-4 content-block small">
                ...
                <div class="title-divider"></div>
                <p>When you arrive at your destination, pay with cash or request your trip with a card or wallet balance. How <?php echo e(config('constants.site_title', 'Moob')); ?>, it's your choice. </p>
            </div>
        </div>
