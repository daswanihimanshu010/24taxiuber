<?php $__env->startSection('title', 'New Dispute Manager'); ?>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header card-header-primary">
              <h4 class="card-title"><?php echo app('translator')->getFromJson('admin.dispute-manager.add_dispute_manager'); ?></h4>
            ...
            <form class="form-horizontal" action="<?php echo e(route('admin.dispute-manager.store')); ?>" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-10">
                        <input class="form-control" type="password" name="password_confirmation" id="password_confirmation" placehold="<?php echo app('translator')->getFromJson('admin.dispute-manager.password_confirmation'); ?>">
                    </div>
                </div>
